...
const savingPattern = (data) => {
  return `        
    <button class="savings__item saving waves-effect waves-teal btn-flat">
...
function currenciesPattern(data, transitionDelay) {
  ...
  const ImageURL = data.Cur_ID === 431 ? URLImagesList[0] :
    data.Cur_ID === 451 ? URLImagesList[1] :
  ...
  if (data.Cur_Name) {
    ...
    return `
        <button class="currencies__item currency waves-effect waves-teal btn-flat" style="animation-delay: ${transitionDelay}s;">
  ...
  `;
    ...
    return `
        <button class="currencies__item currency waves-effect waves-light btn" style="animation-delay: ${transitionDelay}s;">
          <div class="currency__body">
            <div class="currency__img">
              <img src="${ImageURL}" alt="">
            </div>
...
const init = () => {
  ...
  const dynamicURL = `https://www.nbrb.by/API/ExRates/Rates/Dynamics/431?startDate=${firstDayOfYearShort}&endDate=${todayShort}`;
  const URLStatisticsList = [
    `https://www.nbrb.by/API/ExRates/Rates/Dynamics/451?startDate=${firstDayOfYearShort}&endDate=${todayShort}`,      //? Евро
    `https://www.nbrb.by/API/ExRates/Rates/Dynamics/431?startDate=${firstDayOfYearShort}&endDate=${todayShort}`,      //? Доллар США
